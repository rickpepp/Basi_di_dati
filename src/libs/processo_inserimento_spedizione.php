<?php
    ...
    if(isset($_POST['corriere']) && isset($_POST['data']) && isset($_POST['id']) && $dbh -> login_check()) {

        if($dbh -> aggiungi_spedizione($_POST['CodiceTracciamento'], $_POST['corriere'], $_POST['data'], $_POST['id'], $_SESSION['user_id'])) {
