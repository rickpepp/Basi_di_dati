...
function formhashr(form, password, funzione) {
    ...
    if(funzione === 'registrazione') {
        if(document.getElementsByName('nome_registrazione')[0].value === "") {
            ...
            return;
        } else if (document.getElementsByName('codice_fiscale_registrazione')[0].value === "") {
            msg.innerHTML = "Campo Codice Fiscale Vuoto";
            return;
        }  else if (document.getElementsByName('numero_telefono_registrazione')[0].value === "") {
            msg.innerHTML = "Campo Numero Telefono Vuoto";
            return;
            ...
            return;
        } else if (document.getElementsByName('costo_registrazione')[0].value === "") {
            msg.innerHTML = "Campo Costo Dipendente Vuoto";
            return;
        } else if (document.getElementsByName('livello_registrazione')[0].value === "") {
            msg.innerHTML = "Campo Livello Contrattuale Vuoto";
            return;
        }
    }
...
//L'inserimento di un progettista non richiede l'inserimento di password
function controllo_progettista(value) {
    //Pulsante di registrazione
    const but = document.getElementById('rbutton');
